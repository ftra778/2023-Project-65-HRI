...
if webcam_cap == 0:
    cap = cv2.VideoCapture(r"/afs/ec.auckland.ac.nz/users/f/t/ftra778/unixhome/Documents/videos/" + name_of_save + r".mp4")
else:
...
save_loc = r"/afs/ec.auckland.ac.nz/users/f/t/ftra778/unixhome/Documents/videos/" + name_of_save + r".csv"
    ...
    if cap_fail == True:
        ...
        if first_pass is True:
            ...
            AngleHuman.append([(curr_time - start_time), 
                            #    moveLimiter(LShoulderRoll,     AngleHuman[AngleHuman.__len__() - 1][0], 0.3, 0.05), 
                            #    moveLimiter(LElbowRoll,        AngleHuman[AngleHuman.__len__() - 1][1], 0.3, 0.05), 
                            #    moveLimiter(RShoulderRoll,     AngleHuman[AngleHuman.__len__() - 1][2], 0.3, 0.05), 
                            #    moveLimiter(RElbowRoll,        AngleHuman[AngleHuman.__len__() - 1][3], 0.3, 0.05), 
                            #    moveLimiter(HeadYaw,           AngleHuman[AngleHuman.__len__() - 1][4], 0.3, 0.05), 
                            #    moveLimiter(HeadPitch,         AngleHuman[AngleHuman.__len__() - 1][5], 0.3, 0.05), 
                            #    moveLimiter(LShoulderPitch,    AngleHuman[AngleHuman.__len__() - 1][6], 0.3, 0.05), 
                            #    moveLimiter(RShoulderPitch,    AngleHuman[AngleHuman.__len__() - 1][7], 0.3, 0.05), 
                            #    moveLimiter(LElbowYaw,         AngleHuman[AngleHuman.__len__() - 1][8], 0.3, 0.05), 
                            #    moveLimiter(RElbowYaw,         AngleHuman[AngleHuman.__len__() - 1][9], 0.3, 0.05), 
                            #    moveLimiter(HipRoll,           AngleHuman[AngleHuman.__len__() - 1][10], 0.3, 0.05), 
                            #    moveLimiter(HipPitch,          AngleHuman[AngleHuman.__len__() - 1][11], 0.3, 0.05)])
        ...
        if curr_sample >= sample_size:
            ...
            filteredAngles.append([ T[sample_size-1], # Most recent time step
