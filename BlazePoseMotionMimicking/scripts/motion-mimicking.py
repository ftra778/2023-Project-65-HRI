...
if webcam_cap == 0:
    ...
    cap = cv2.VideoCapture(r"C:\Users\caley\OneDrive\Documents\P4P Human Robot Interaction\2023-Project-65-HRI\BlazePoseMotionMimicking\videos\wave.mp4")
else:
...
save_loc = r"C:\Users\caley\OneDrive\Documents\P4P Human Robot Interaction\2023-Project-65-HRI\BlazePoseMotionMimicking\csv\wave-time.csv"
    ...
    if frame_counter % 1 == 0:
        ...
        if cap_fail == True:
            ...
            if curr_sample >= sample_size:
                ...
                filteredAngles.append([T[sample_size-1], np.mean(LSR), np.mean(LER), np.mean(RSR), np.mean(RER), 
