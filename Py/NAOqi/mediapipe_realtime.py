...
if webcam_cap == 0:
    cap = cv2.VideoCapture(r"/afs/ec.auckland.ac.nz/users/f/t/ftra778/unixhome/Downloads/2023-Project-65-HRI-main/2023-Project-65-HRI-main/BlazePoseMotionMimicking/videos/beckon.mp4")
else:
